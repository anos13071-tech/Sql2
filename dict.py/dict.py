data = [
    ...
    {"full_name":"Layne Thomel","company":"Centimia","position":"Human Resources Manager","salary":"$4073.17"},
...
ja=0
for item in data:
    if item["position"]=="Human Resources Manager":
        ja+=1
print(ja)
# 2-------------------------------
# oyliy=0
# for item in data:
#    if item["company"]=="Riffpath":
#       salary=float(item["salary"].replace("$",""))
#       oyliy+=salary
# print(oyliy)
# 3-------------------------------
# for item in data:
#     if item["full_name"].startswith("K"):
#         salary=float(item["salary"].replace("$",""))
#         salary=salary * 2
#         print(item["full_name"],salary)
# 4-------------------------------
# for item in data:
#     item['FIO']=item.pop("full_name")
# print(data)
# 6------------------------------
# ja=0
# for item in data:
#     if "position" in item and"Assistant"in item["position"].strip():
#         ja+=1
# print(ja)
